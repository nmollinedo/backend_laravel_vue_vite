...
/**
     ...
     * )
     */
    public function funListarPoblacion(){
        $plan = DB::select('select * from clasificadores.poblaciones');
    ...
    public function funListarPoblacionMuni($id){
        $programa = DB::select("select * from clasificadores.poblaciones where clasificadores.poblaciones.municipio_id=$id");
